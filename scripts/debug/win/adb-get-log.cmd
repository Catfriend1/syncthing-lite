...
IF NOT DEFINED PID echo [ERROR] Syncthing-Lite DEBUG is NOT installed. & FOR /F "delims=" %%I IN ('adb shell pidof %PACKAGE_NAME:.debug=%') DO SET PID=%%I
IF NOT DEFINED PID echo [ERROR] Syncthing-Lite RELEASE is NOT installed. Please install it first. Stop. & goto :eof
::
